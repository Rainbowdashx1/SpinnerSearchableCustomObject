...
{
    public class SpinnerCustomObjV7 : EditText
    {
        private SpinnerCustomV7 sc;
        private Android.App.FragmentManager fg;
        private object ResultData;
        private Android.Graphics.Color TextColorSpinner;
        private Android.Graphics.Color BackGroundColorSpinner;
        public SpinnerCustomObjV7(Android.Content.Context con, Android.Util.IAttributeSet attr) : base(con, attr)
        {
        ...
        {
            sc = new SpinnerCustomV7(Data, BackGroundColorSpinner, TextColorSpinner);
            sc.EventClickSpinner += Sc_EventClickSpinner;
            this.fg = fg;
        }
        private void Sc_EventClickSpinner(object sender, SpinnerCustomV7.DialogEventArgs args)
        {
